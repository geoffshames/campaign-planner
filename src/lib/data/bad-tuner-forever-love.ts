...
export const badTuner = {
  ...
  videoIntel: {
    ...
    videos: [
      ...
      { title: 'Public Records (Thu night)', artist: 'bad tuner', plays: '3.4K plays · 106 likes', insight: 'Casual room + dance energy reads as a moment — until the flyer caption caps it.' },
      { title: 'March 5 (show promo)', artist: 'bad tuner', plays: '3.0K plays · 121 likes', insight: 'Consistent color theme, but it’s still a show flyer — the exact trap to escape.' },
      ...
      { title: 'Out here making it', artist: 'bad tuner', plays: '1.4K plays · 18 saves', insight: 'Process framing + varied shots — his best non-flyer instinct.' },
      ...
      { title: 'contentcontentcontenthelp', artist: 'Barry Cant Swim', plays: '12.6K plays · 1K likes', insight: 'Self-aware meta humor; personality travels even with no text hook.' },
      { title: 'Lot Radio set → full set on YT', artist: 'Barry Cant Swim', plays: '20.2K plays · 1.6K likes', insight: 'Live clip funneling to the full YouTube set — the model to copy.' },
      { title: 'Warehouse Project night', artist: 'Barry Cant Swim', plays: '12.1K plays · 963 likes', insight: 'Big-room lights + crowd; raw energy carries the clip.' },
      ...
      { title: 'Big Dunc — new music soon', artist: 'Barry Cant Swim', plays: '51.6K plays · 1.8K likes', insight: 'Named-motif tease + new-music-soon = his highest reach in the set.' },
      { title: 'Bhibo is returning (unreleased)', artist: 'Barry Cant Swim', plays: '13.5K plays · 1.4K likes', insight: 'Same unreleased track, re-teased under a recurring name. The motif engine.' },
      { title: 'I luv U (wallfacer), 10th song', artist: 'Fred Again', plays: '1.07M plays · 117K likes', insight: 'Live moment + Apple Music funnel; the show IS the content.' },
      ...
      { title: 'Mike Skinner — remain in the streets', artist: 'Fred Again', plays: '1.43M plays', insight: 'A single line of story over a live moment = millions.' },
      { title: 'Daft Punk', artist: 'Fred Again', plays: '2.52M plays · 332K likes', insight: 'Iconic collab moment; the caption is just emojis — the moment carries.' },
      { title: 'Glastonbury, cant stop watching', artist: 'Fred Again', plays: '1.62M plays · 212K likes', insight: 'Vulnerable diary caption under a live high. Pure Fred.' },
      { title: 'Duet + sample build', artist: 'Joy Anonymous', plays: '1.3K plays', insight: 'Duet + sample; process framing invites participation.' },
      { title: 'Rio (wobble)', artist: 'Joy Anonymous', plays: '601 plays', insight: 'Crowd clip with the drop landing on the beat — their one on-peak example.' },
      { title: 'Nintendo DS in the rave', artist: 'Joy Anonymous', plays: '616 plays', insight: 'Quirky object hook (DS in the rave) — personality over polish.' },
  ...
  ideas: [
    ...
    { name: 'Bodega Sessions', bit: 'Sample the door chime, the fridge hum, the bodega cat — and the cat becomes a recurring character.', hook: 'the bodega cat made this', why: 'Lifestyle + humor + a motif fans come back for.', top3: false },
    { name: 'forever love, one loop a week', bit: 'Reveal the same EP hook in a new NYC setting each week (rooftop, 3am platform, chopped, sped-up) until comments scream WHEN.', hook: 'you’ve heard this 6 times now', why: 'The anticipation spine across all four singles — the Bhibo move.', top3: true },
    ...
    { name: 'Diggin’', bit: 'Pull a record at A1 or The Thing, tell its story, flip a sample from it on camera.', hook: 'found this in a $1 bin', why: 'Story-driven sample content — the Sneaky Pete move, localized.', top3: false },
