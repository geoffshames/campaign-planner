...
export const badTuner = {
  ...
  videoIntel: {
    ...
    videos: [
      ...
      { title: 'Public Records (Thu night)', artist: 'bad tuner', plays: '3.4K plays Â· 106 likes', insight: 'Casual room + dance energy reads as a moment â until the flyer caption caps it.' },
      { title: 'March 5 (show promo)', artist: 'bad tuner', plays: '3.0K plays Â· 121 likes', insight: 'Consistent color theme, but it’s still a show flyer â the exact trap to escape.' },
      { title: 'Public Records tonight', artist: 'bad tuner', plays: '684 plays', insight: 'Crowd interaction works; the promo caption is the ceiling.' },
      { title: 'Out here making it', artist: 'bad tuner', plays: '1.4K plays Â· 18 saves', insight: 'Process framing + varied shots â his best non-flyer instinct.' },
      { title: 'Lot Radio, playing the demos', artist: 'bad tuner', plays: '452 plays', insight: 'The long-set asset is right there and underused; this feeds the clipping campaign.' },
      { title: 'contentcontentcontenthelp', artist: 'Barry Cant Swim', plays: '12.6K plays Â· 1K likes', insight: 'Self-aware meta humor; personality travels even with no text hook.' },
      { title: 'Lot Radio set → full set on YT', artist: 'Barry Cant Swim', plays: '20.2K plays Â· 1.6K likes', insight: 'Live clip funneling to the full YouTube set â the model to copy.' },
      { title: 'Warehouse Project night', artist: 'Barry Cant Swim', plays: '12.1K plays Â· 963 likes', insight: 'Big-room lights + crowd; raw energy carries the clip.' },
      { title: 'b2b w/ Sammy Virji, Ally Pally', artist: 'Barry Cant Swim', plays: '5K plays', insight: 'Collab b2b = borrowed audience; tag the bigger peer.' },
      { title: 'Big Dunc â new music soon', artist: 'Barry Cant Swim', plays: '51.6K plays Â· 1.8K likes', insight: 'Named-motif tease + new-music-soon = his highest reach in the set.' },
      { title: 'Bhibo is returning (unreleased)', artist: 'Barry Cant Swim', plays: '13.5K plays Â· 1.4K likes', insight: 'Same unreleased track, re-teased under a recurring name. The motif engine.' },
      { title: 'I luv U (wallfacer), 10th song', artist: 'Fred Again', plays: '1.07M plays Â· 117K likes', insight: 'Live moment + Apple Music funnel; the show IS the content.' },
      { title: 'Whole show live on Apple Music', artist: 'Fred Again', plays: '585K plays', insight: 'The clip is the trailer; the full show is the destination.' },
      { title: 'Mike Skinner â remain in the streets', artist: 'Fred Again', plays: '1.43M plays', insight: 'A single line of story over a live moment = millions.' },
      { title: 'Daft Punk', artist: 'Fred Again', plays: '2.52M plays Â· 332K likes', insight: 'Iconic collab moment; the caption is just emojis â the moment carries.' },
      { title: 'Glastonbury, cant stop watching', artist: 'Fred Again', plays: '1.62M plays Â· 212K likes', insight: 'Vulnerable diary caption under a live high. Pure Fred.' },
      { title: 'Duet + sample build', artist: 'Joy Anonymous', plays: '1.3K plays', insight: 'Duet + sample; process framing invites participation.' },
      { title: 'Rio (wobble)', artist: 'Joy Anonymous', plays: '601 plays', insight: 'Crowd clip with the drop landing on the beat â their one on-peak example.' },
      { title: 'Nintendo DS in the rave', artist: 'Joy Anonymous', plays: '616 plays', insight: 'Quirky object hook (DS in the rave) â personality over polish.' },
      { title: 'Buttery Brisket Bass', artist: 'Joy Anonymous', plays: '144 plays', insight: 'Food-pun + bass; playful wordplay as the hook.' },
    ],
  },
  ...
  ideas: [
    { name: 'Found Sound (NYC Sound Map)', bit: 'Find a NYC sound, sample it on the phone, flip it into a loop in-studio (discovery → capture → build). Pin a Brooklyn map that fills in episode by episode.', hook: 'made a beat from the L train at Bedford', why: 'The proven 6/6 NYC-sound format, made into an episodic flagship.', top3: true },
    { name: 'One Line, One Beat', bit: 'Ride a single subway line end-to-end and build a track using only sounds captured on that line.', hook: 'one train, one beat — the L', why: 'Constraint + NYC identity + a built-in series, all in one.', top3: false },
    { name: 'Bodega Sessions', bit: 'Sample the door chime, the fridge hum, the bodega cat â and the cat becomes a recurring character.', hook: 'the bodega cat made this', why: 'Lifestyle + humor + a motif fans come back for.', top3: false },
    { name: 'forever love, one loop a week', bit: 'Reveal the same EP hook in a new NYC setting each week (rooftop, 3am platform, chopped, sped-up) until comments scream WHEN.', hook: 'you’ve heard this 6 times now', why: 'The anticipation spine across all four singles â the Bhibo move.', top3: true },
    { name: 'The Central Park Booth', bit: 'A lightly-announced pop-up DJ booth in a public space, filmed for live clips + crowd reactions.', hook: 'surprise set, Central Park', why: 'The live tentpole; one shoot feeds a week of content and the clipping campaign.', top3: true },
    { name: 'Send Me a Sound', bit: 'Fans DM a NYC sound or a 5-second voice note; he builds a beat from it on camera and tags them.', hook: 'you sent this, I flipped it', why: 'Turns the comment section into co-creation.', top3: false },
    { name: '3AM in [neighborhood]', bit: 'Late-night phone walk home, unreleased loop playing, short diaristic caption.', hook: '3am in Bushwick', why: 'The globally-appealing lifestyle/mood content the call asked for.', top3: false },
    { name: 'Diggin’', bit: 'Pull a record at A1 or The Thing, tell its story, flip a sample from it on camera.', hook: 'found this in a $1 bin', why: 'Story-driven sample content â the Sneaky Pete move, localized.', top3: false },
    { name: 'Soundcheck POV', bit: '15-second POV: empty room → soundcheck → the first drop as the room fills.', hook: 'before the room knows', why: 'Converts show-promo into a moment; the gig info rides as soft secondary.', top3: false },
    { name: 'Same Sample, Two Heads', bit: 'Invite an NYC/garage peer to the studio; both flip the same sample differently, split-screen the result.', hook: 'same sample, two producers', why: 'Borrowed audience via the collab format; can route through &friends.', top3: false },
  ],

  // ââ 07 Weekly Playbook (10 weeks, relative to release) ââ
  playbook: [
