...
export const miguelDamned = {
  ...
  activations: [
    ...
    },
    {
      ...
      timing: 'Launch Week 2 · 30–45 day flight',
      description:
        'Strive pays rideshare drivers to play campaign tracks; 30+ second listens register as real Spotify streams from real, geo-distributed listeners. Program damned as the lead track (plus Sure Thing and Adorn as catalog support slots in the 5-song campaign). Geo-weight to the cities where Shazam shows active song-hunting (Denver, Charlotte, Irvine) plus core US markets (LA, NYC, Houston, Chicago). The 30–45 day flight outlives the sprint window by design — it keeps real-listener streams feeding the algorithm through the month-two decision point. Beyond the ~150K streams, the second-order effect is the point: rideshare plays drive passenger Shazams and saves — the exact signals feeding the algorithmic playlisting that is already +93% week-over-week.',
      kpis: ['150K streams pacing to full delivery by Day 45', 'Shazam weekly velocity holds ≥+20%', 'Save rate on campaign streams ≥8%'],
    },
    {
