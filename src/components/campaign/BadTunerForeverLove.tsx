...
import { badTuner as C } from '@/lib/data/bad-tuner-forever-love';
...
/* ── page ── */
export function BadTunerForeverLove() {
    ...
    <div className="bg-[#0A0A0A] text-[#FAFAFA] min-h-screen relative">
      ...
      <div ref={heroRef} className="relative h-[88vh] min-h-[600px] flex items-end overflow-hidden">
        <motion.div className="absolute inset-0 z-0" style={{ y: heroY }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/bad-tuner-forever-love/hero.png" alt="" className="w-full h-full object-cover" />
      ...
      <Section id="video" number="03" title="Video Intelligence" subtitle={C.videoIntel.summary}>
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="text-[#B8B8C0] text-sm">{C.videoIntel.analyzed} top comp videos analyzed frame-by-frame</span>
        </div>
        ...
        <div className="text-[11px] uppercase tracking-wider text-[#fd3737] mb-4">Deep-dive · all 26 posts</div>
      ...
      <Section id="strategy" number="04" title="The Strategy" subtitle="One thesis, four phases.">
        <GlassCard className="p-8 md:p-12 mb-12 relative overflow-hidden" glow hover={false}>
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/bad-tuner-forever-love/strategy.png" alt="" className="absolute inset-0 w-full h-full object-cover opacity-10" />
      ...
      <div className="relative mt-16 overflow-hidden">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/bad-tuner-forever-love/closing.png" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20" />
...
export default BadTunerForeverLove;
