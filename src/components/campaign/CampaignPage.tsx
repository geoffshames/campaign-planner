          ...
          <GlassCard className="lg:col-span-2 p-8" hover={false}>
            ...
            <div className="mt-4 space-y-3">
              {platformData.map((item, i) => (
                ...
                >
                  <span className="flex items-center gap-3" style={{ color: item.color }}>
          ...
          <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {campaign.social.map((platform, i) => (
              <GlassCard key={i} className="p-6">
                ...
                <div className="font-display text-3xl md:text-4xl text-white tracking-tight mb-1">{platform.followers}M</div>
