...
function StatBlock({ label, value, sub }: { label: string; value: string; sub?: string }) {
  return (
    <div>
      <div className="text-[10px] tracking-[0.25em] uppercase text-[#B8B8C0] font-semibold mb-2">{label}</div>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-[#333333]/30">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <span className="hidden md:block text-[11px] tracking-[0.2em] uppercase text-[#B8B8C0] font-semibold">Campaign Planner</span>
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16 pb-20 md:pb-28">
          ...
          >
            <div className="flex flex-wrap items-center gap-3 mb-8">
              ...
              <Badge color="#E4E4E9">{campaign.releaseDate}</Badge>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-8 text-sm">
              <div>
                <span className="text-[#B8B8C0] text-[10px] tracking-[0.25em] uppercase block mb-1">Campaign Window</span>
                <span className="text-[#E4E4E9] font-normal">{campaign.campaignWindow.start} — {campaign.campaignWindow.end}</span>
              </div>
              <div className="h-8 w-px bg-[#333333]" />
              <div>
                <span className="text-[#B8B8C0] text-[10px] tracking-[0.25em] uppercase block mb-1">Release Date</span>
                <span className="text-[#E4E4E9] font-normal">{campaign.releaseDate}</span>
              </div>
              <div className="h-8 w-px bg-[#333333]" />
              <div>
                <span className="text-[#B8B8C0] text-[10px] tracking-[0.25em] uppercase block mb-1">Prepared By</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <GlassCard className="p-8" hover={false}>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                <div className="text-[10px] tracking-[0.25em] uppercase text-[#B8B8C0] mb-3">Gender Split</div>
                <div className="flex items-end gap-4">
                  ...
                  <div>
                    <div className="font-display text-3xl text-[#E4E4E9]">{campaign.demographics.malePercent}%</div>
                    <div className="text-[#B8B8C0] text-xs mt-1">Male</div>
                  </div>
                </div>
              </div>
              <div>
                <div className="text-[10px] tracking-[0.25em] uppercase text-[#B8B8C0] mb-3">Primary Age</div>
                <div className="font-display text-3xl text-white">{campaign.demographics.primaryAge}</div>
                <div className="text-[#B8B8C0] text-xs mt-1">{campaign.demographics.primaryAgePercent}% of audience</div>
              </div>
            </div>
            <div className="mt-8 pt-6 border-t border-[#333333]/50">
              <div className="text-[10px] tracking-[0.25em] uppercase text-[#B8B8C0] mb-3">Ethnicity Breakdown</div>
        ...
        <GlassCard className="p-8" hover={false}>
          ...
          <div className="flex flex-wrap gap-3">
            {['Phone-shot aesthetic', 'Behind-the-scenes studio content', 'Fan reaction compilations', 'Lo-fi lyric teasers', 'Day-in-the-life vlogs', 'Challenge tutorials', 'Collab mashups'].map((trend, i) => (
              <span key={i} className="px-4 py-2 rounded-full bg-[#262626]/80 text-[#E4E4E9] text-sm font-normal border border-[#333333]/50 hover:border-[#fd3737]/30 hover:text-white transition-all duration-300">
                {trend}
              </span>
            ))}
          </div>
              ...
              <motion.div key={idx} variants={fadeUp}>
                ...
                >
                  ...
                  >
                    ...
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300 ${expandedWeek === idx ? 'bg-[#fd3737]/10 text-[#fd3737] rotate-45' : 'bg-[#262626] text-[#B8B8C0]'}`}>
                            ...
                            <div className="space-y-3">
                              {week.successSignals.map((signal, j) => (
                                <div key={j} className="flex gap-4 items-start">
                                  ...
                                  <span className="text-[#E4E4E9] text-sm font-normal leading-relaxed">{signal}</span>
                                </div>
                              ))}
                            </div>
                          </div>
            ...
            <GlassCard key={i} className="p-8 relative overflow-hidden">
              ...
              <div className="flex flex-wrap gap-2">
                {pillar.platforms.map((p, j) => (
                  <span key={j} className="text-[10px] tracking-wider uppercase px-3 py-1.5 rounded-full bg-[#262626] text-[#B8B8C0] border border-[#333333]/50">
                    {p}
                  </span>
                ))}
              </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#333333]/50">
                  <th className="text-left py-4 px-8 text-[10px] tracking-[0.25em] uppercase text-[#B8B8C0] font-semibold">Platform</th>
                  <th className="text-left py-4 px-8 text-[10px] tracking-[0.25em] uppercase text-[#B8B8C0] font-semibold">Frequency</th>
                  <th className="text-left py-4 px-8 text-[10px] tracking-[0.25em] uppercase text-[#B8B8C0] font-semibold">Content Types</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  { platform: 'X', frequency: 'Real-time + 2x daily', type: 'Engagement, Updates', color: '#E4E4E9' },
                ].map((item, i) => (
                  <tr key={i} className="border-b border-[#333333]/20 hover:bg-[#1a1a1a]/50 transition-colors">
                    ...
                    <td className="py-4 px-8 text-[#E4E4E9] text-sm font-normal">{item.frequency}</td>
              ...
              <GlassCard key={i} className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[#E4E4E9] text-sm font-normal leading-relaxed">{item.rationale}</p>
                  </div>
                </div>
              </GlassCard>
            ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {campaign.risks.map((risk, i) => (
            <GlassCard key={i} className="p-8">
              ...
              <div className="space-y-5">
                <div>
                  <div className="text-[10px] tracking-[0.25em] uppercase text-[#B8B8C0] font-semibold mb-2">Trigger Signal</div>
                  <p className="text-[#E4E4E9] text-sm font-normal leading-relaxed">{risk.triggerSignal}</p>
                </div>
                <div className="pt-4 border-t border-[#333333]/50">
                  ...
                  <p className="text-[#E4E4E9] text-sm font-normal leading-relaxed">{risk.contingency}</p>
                </div>
              </div>
            </GlassCard>
          ))}
